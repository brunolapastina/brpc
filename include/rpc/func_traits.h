/**
 * This file was shamelessly copied from the rcplib project
 * https://github.com/rpclib/
 * This is an awsome implementation so why should I change anything???
 *
 * In fact, I grouped 4 files, just for convenience sake
 */
#pragma once
...
// from rpc/detail/constant.h
template<typename T, T I>
struct constant : std::integral_constant<T, I> {};

// from rpc/detail/bool.h
template<bool B>
...
template <typename F> using is_zero_arg = is_zero<func_traits<F>::arg_count::value>;
